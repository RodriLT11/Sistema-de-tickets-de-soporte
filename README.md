...
| Tabla            | Campos                                                                                      |
|------------------|---------------------------------------------------------------------------------------------|
| users            | id, username, email, password, role, avatar, created_at, status                            |
| tickets          | id, ticket_number, user_id, agent_id, category_id, priority, subject, status, created_at, updated_at, closed_at |
| ticket_messages  | id, ticket_id, user_id, message, is_internal, created_at, attachments                       |
| categories       | id, name, description                                                                      |
| attachments      | id, ticket_id, message_id, filename, filepath, filesize, uploaded_by, created_at           |
| ticket_history   | id, ticket_id, user_id, action, old_value, new_value, created_at                            |
| ratings          | id, ticket_id, user_id, rating, comment, created_at                                        |
| notifications    | id, user_id, ticket_id, message, is_read, created_at                                       |
| knowledge_base   | id, title, content, category_id, views, created_at                                         |
| tags             | id, name                                                                                   |
...
El proyecto incluye todos los aspectos de un sistema de soporte profesional incluyendo autenticación, autorización, CRUD completo, dashboards, reportes, notificaciones y características avanzadas como SLA y base de conocimiento.
